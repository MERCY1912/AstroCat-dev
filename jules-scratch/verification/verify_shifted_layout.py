...
def run(playwright):
    ...
    header.screenshot(path="jules-scratch/verification/shifted_layout_mobile.png")

    # Set viewport to a desktop size
    page.set_viewport_size({"width": 1280, "height": 720})

    # Take a screenshot of the header on desktop
    header.screenshot(path="jules-scratch/verification/shifted_layout_desktop.png")
